...
Adopted nearly as-is from proposal/v3-foundation
``src/caselinker/snapshots/manifest.py``. Live path is
``scripts/verify/paper/manifest.py`` — not a ``src/caselinker/`` package.
Stdlib-only; hashes are canonical-JSON SHA-256.
"""
